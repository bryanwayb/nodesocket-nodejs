...
module.exports = {
	nodesocketSignature: new Buffer('nsockv01', encoding),
	...
	parseExecutePayload: function(functions, payload, error) {
		...
		var identifier = payload.slice(4, identifierEndPosition).toString(encoding);
			...
			for(var i = identifierEndPosition; i < payload.length;) {
				...
				switch(dataType) {
					...
					case module.exports.EnumDataType.string:
						var next = i + dataSize;
						value = payload.slice(i, next).toString(encoding);
						i = next;
						break;
	...
	parseResultPayload: function(buffer) {
		...
		switch(dataType) {
			...
			case module.exports.EnumDataType.double:
				...
				break;
			case module.exports.EnumDataType.string:
				result = buffer.slice(1).toString(encoding);
				break;
			case module.exports.EnumDataType.ubyte:
